...
<div class="app">
  ...
  <p>نقطة دخول موحدة لإدارة النظام، عرض اللوحات، وربط الوحدات الأساسية بطريقة ذكية.</p>
...
// الوظيفة التي تشغّل كل وحدة بالترتيب
...
document.getElementById('dashboardBtn').addEventListener('click',()=>{
  // لوحة تحكم مباشرة، يمكن تعديل الرابط الفعلي لاحقًا
  window.location.href='AYHEM_DASHBOARD.html';
});
</script>
</body>
</html>
